                        ...
                        <div class="product-short-text">
                            ...
                            <ul class="icons mt-4">
                                <li class="text-sm">
                                    ...
                                    <strong>Sklep:</strong> <a
                                            href="<?= Url::to(['shop/view', 'slug' => $item->shop->slug]) ?>"><?= Html::encode($item->shop->name) ?></a>
                                </li>
                                <li class="text-sm">
            ...
            <div class="tabs tabs--style-1" role="tabpanel">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="<?= Url::toRoute(['item/view', 'id' => $item->id, 'slug' => $item->slug]) ?>"
                           class="nav-link text-center text-uppercase strong-600 <?= $view != null ?: 'active' ?>">PODOBNE
                            PRODUKTY</a>
                    </li>

                    <li class="nav-item" role="presentation">
                        <a href="<?= Url::toRoute(['item/view', 'id' => $item->id, 'slug' => $item->slug, 'view' => 'review']) ?>"
                           class="nav-link text-center text-uppercase strong-600 <?= $view != 'review' ?: 'active' ?>">Opinie</a>
                    </li>
                </ul>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tabFour-3">
                        <div class="tab-body">
                            ...
                            <?php elseif ($view == 'review'): ?>
                                ...
                                <?php if ($reviewDataProvider->getTotalCount() > 0): ?>
